...
<div class="container">
    ...
    <form method="POST" action="{{ route('obituaries.update', $obituary->id) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="{{ $obituary->name }}" required placeholder="Enter the deceased's full name">
        </div>

        <div class="form-group">
            <label for="dob">Date of Birth:</label>
            <input type="date" name="date_of_birth" id="dob" value="{{ $obituary->date_of_birth }}" required>
        </div>

        <div class="form-group">
            <label for="dod">Date of Death:</label>
            <input type="date" name="date_of_death" id="dod" value="{{ $obituary->date_of_death }}" required>
        </div>

        <div class="form-group">
            <label for="content">Obituary Content:</label>
            <textarea name="content" id="content" required placeholder="Write a detailed obituary">{{ $obituary->content }}</textarea>
        </div>

        <div class="form-group">
            <label for="author">Author's Name:</label>
            <input type="text" name="author" id="author" value="{{ $obituary->author }}" required placeholder="Enter your name as the author">
        </div>

        <button type="submit" class="btn-submit">Update Obituary</button>
    </form>
</div>
